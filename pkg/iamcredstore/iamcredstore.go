...
type IAMUserCredentials struct {
...
func Retrieve(key string, target IAMUserCredentials) (*IAMUserCredentials, error) {
...
func Store(key string, payload IAMUserCredentials) error {
	ring, err := openKeyring()
	if err != nil {
		return err
	}
