...
func TestParseGitURL(t *testing.T) {
	tests := []struct {
		...
		{
			name: "http github.com with granted.yml and subpath; should return without subpath",
			url:  "http://github.com/Eddie023/granted-registry.git/granted.yml/team_a/team_b/",
			want: GitURL{
				ProvidedURL: "http://github.com/Eddie023/granted-registry.git/granted.yml/team_a/team_b/",
				Host:        "github.com",
				Org:         "Eddie023",
				Repo:        "granted-registry",
				Subpath:     "",
		...
		{
			name: "http github.com without subpath but with config.yml",
			url:  "http://github.com/Eddie023/granted-registry.git/config.yml/",
			want: GitURL{
				ProvidedURL: "http://github.com/Eddie023/granted-registry.git/config.yml/",
				Host:        "github.com",
				Org:         "Eddie023",
				Repo:        "granted-registry",
				Filename:    "config.yml",
		...
		{
			name: "http github.com with subpath and config.yml file",
			url:  "http://github.com/Eddie023/granted-registry.git/team_a/config.yml",
			want: GitURL{
				ProvidedURL: "http://github.com/Eddie023/granted-registry.git/team_a/config.yml",
				Host:        "github.com",
				Org:         "Eddie023",
				Repo:        "granted-registry",
				Filename:    "config.yml",
		...
		{
			name: "http github.com with subpath and config.yml file with slash",
			url:  "http://github.com/Eddie023/granted-registry.git/config.yml/",
			want: GitURL{
				ProvidedURL: "http://github.com/Eddie023/granted-registry.git/config.yml/",
				Host:        "github.com",
