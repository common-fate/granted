...
func GetCliApp() *cli.App {
	...
	app := &cli.App{
		...
		HideVersion:          false,
		Commands:             []*cli.Command{&DefaultBrowserCommand, &settings.SettingsCommand, &CompletionCommand, &TokenCommand, &UninstallCommand, &SSOCommand, &KeychainCommand, &CredentialProcess},
